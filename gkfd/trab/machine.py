            ...
            if i == 1 and MK_DESC:
                for _ in range(8):
                    m = pg.evaluate("()=>{const s=document.querySelector('.s');"
                        ...
                        "if(c.classList.contains('topband')||c.classList.contains('brand')"
                        "||c.classList.contains('selomarca')||c.classList.contains('prog')"
                        "||c.classList.contains('publico')||c.classList.contains('rodape-ad'))continue;"
